...
/* 
   ...
   you need to define NATIVE_BIG_ENDIAN                         如果您希望MAVLink在一个原生的big-endian系统上运行，您需要定义NATIVE_BIG_ENDIAN
*/
#ifdef NATIVE_BIG_ENDIAN        //0
# define MAVLINK_NEED_BYTE_SWAP (MAVLINK_ENDIAN == MAVLINK_LITTLE_ENDIAN)
#else
# define MAVLINK_NEED_BYTE_SWAP (MAVLINK_ENDIAN != MAVLINK_LITTLE_ENDIAN)     //(1!=1)  0
#endif
...
/* option to provide alternative implementation of mavlink_helpers.h  提供mavlink_helpers.h替代实现的选项*/
...
/**
 * @brief Get the required buffer size for this message			//获取此消息所需的缓冲区大小
 */
...
#if MAVLINK_NEED_BYTE_SWAP				//小端模式  先发送低字节 低字节在前

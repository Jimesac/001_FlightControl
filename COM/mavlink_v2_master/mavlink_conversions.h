 ...
 * available online.
 * 这些转换函数遵循在线提供的美国国家航空航天局旋转标准定义文件。
 *
...
/**
 * Converts a quaternion to a rotation matrix           //将四元数转换为旋转矩阵
 *
...
/**
 * Converts a rotation matrix to euler angles       //将旋转矩阵转换为欧拉角
 *
 * @param dcm a 3x3 rotation matrix
...
/**
 * Converts a quaternion to euler angles        //将四元数转换为欧拉角
 *
 * @param quaternion a [w, x, y, z] ordered quaternion (null-rotation being 1 0 0 0)
 * @param roll the roll angle in radians
 * @param pitch the pitch angle in radians
...
/**
 * Converts euler angles to a quaternion            //将欧拉角转换为四元数
 *
 * @param roll the roll angle in radians
 * @param pitch the pitch angle in radians
 * @param yaw the yaw angle in radians
...
/**
 * Converts euler angles to a rotation matrix       //将欧拉角转换为旋转矩阵
 *
 * @param roll the roll angle in radians
 * @param pitch the pitch angle in radians
 * @param yaw the yaw angle in radians

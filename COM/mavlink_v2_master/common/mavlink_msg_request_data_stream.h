 ...
 *
 * @param target_system  The target requested to send the message stream.       //请求发送消息流的目标。
 * @param target_component  The target requested to send the message stream.    //目标组件
 * @param req_stream_id  The ID of the requested data stream                    //请求的数据流的ID
 * @param req_message_rate [Hz] The requested message rate                      //请求的消息速率
 * @param start_stop  1 to start sending, 0 to stop sending.                    //1表示开始发送，0表示停止发送。
